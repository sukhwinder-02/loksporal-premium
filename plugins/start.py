        ...
        if "verify_" in message.text:
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                btn = [
                    ...
                    [InlineKeyboardButton('• ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ •', url = "https://t.me/Ott_Sandhu")]
                ]
                await message.reply(f"<b>Your token has expired. Please refresh your token to continue.\n\nToken Timeout: {get_exp_time(VERIFY_EXPIRE)}\n\nWhat is the token?\n\nThis is an ads token. Passing one ad allows you to use the bot for {get_exp_time(VERIFY_EXPIRE)}\n\nIf you're facing issues with verification, contact: @baii_Ji</b>", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
    ...
    buttons = [
        [
            InlineKeyboardButton(
                "• ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 1",
                url = "https://t.me/+-QFNuy-me-gyNTJl")],
            [InlineKeyboardButton(
                "• ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 2",
                url = "https://t.me/+Ui3aRVsPFIplNjBl")
        ]
    ]
    try:
        buttons.append(
